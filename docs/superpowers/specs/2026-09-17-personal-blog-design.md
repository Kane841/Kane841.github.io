...
日期：2026-09-17  
状态：待审阅  
范围：功能、内容、发布、异常与测试。外观、布局、视觉气质见 [2026-09-17-personal-blog-ui-design.md](./2026-09-17-personal-blog-ui-design.md)。
...
各模块可独立理解：改页面不改内容字段；改外观文档（[2026-09-17-personal-blog-ui-design.md](./2026-09-17-personal-blog-ui-design.md)）只影响路由页面的呈现，不影响查询规则与发布。
